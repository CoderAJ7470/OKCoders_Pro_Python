...
# If the user enters 0 as the second number, the program will use that as the numerator and inform the user a such, since division by 0 is not allowed.
...
# An informative message telling the user which numbers he/she input, and which operation was chosen
